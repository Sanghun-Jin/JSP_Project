...
<%@ page import="java.util.*, java.text.*"  %>
    ...
    try {
    	...
    	String sql = "select count(*) from icomm where num = ?";
...
try {
	conn = DriverManager.getConnection( "jdbc:mysql://localhost:3306/user?serverTimezone=UTC" , "root", "jws020507");
	sql = "SELECT title, maker, day, data FROM imgnot WHERE idx=?";
...
<a href="logout.jsp">로그아웃</a>
	...
	<form method="post" name="cccomt" action="icomt.jsp" onsubmit="return checkcoomt()">
	<tr>
	<td>
	<div class="coment">
