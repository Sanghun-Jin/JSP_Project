...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="top">
      ...
      <div class="menu">
        <ul>
      <li><a class="menulink1" href="commrp.jsp">일반게시판</a></li>
      <li>|</li>
...
<a href="logout.jsp">로그아웃</a>
   ...
   <section class="no">
    ...
    <br>
    <br>
    <div class="contit"><h3>일반게시판</h3></div>
	<table>
	<tr>
	<td>
	<div class="right">
    ...
    try {
    	...
    	String sql = "select count(*) from comnot where title like ? or maker like ?";
    	...
    	sql = "select * from comnot where title like ? or maker like ?";
    	pstmt = conn.prepareStatement(sql);
