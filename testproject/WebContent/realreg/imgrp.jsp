...
<%
    ...
    try {
    	...
    	sql = "select * from icomm where num=?;";
    	apstmt = conn.prepareStatement(sql); 
...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="top">
      ...
      <li>|</li>
      <li><a class="menulink1" href="imgrp.jsp">이미지게시판</a></li>
      <li>|</li>
...
<a href="logout.jsp">로그아웃</a>
   ...
   <section class="no">
    ...
    <br>
    <br>
    <div class="contit"><h3>이미지게시판</h3></div>
	<table>
	<tr>
	<td>
	<div class="right">
	...
	<div class="mid">
	<div class="content">
	<form method="post" name="schval" action="imgrpsch.jsp" onsubmit="return schck()">
	<table>
	<tr>
	<td><input name="search" type="text" value="" placeholder="게시물 또는 글쓴이"></td>
	<td><input type="submit" value="검색"></td>
	<td width="750px;"><div style="margin-left: 74%;"><a  href="imgtyp.jsp">글쓰기</a><br></div></td>
	</tr>
	</table>
	</form>
	<%
...
%>
	<tr class="cdrow" height="25" align="center"onclick="location.href='iview.jsp?cidx=<%=cidx%>'">
	<td>&nbsp;</td>
	<td></td>
